package com.scale.bat.webservice;
...
public class WishListServiceStepDefs {
	...
	public void user_access_the_webservice_of_GetWishList() {
		access_hash=apibase.getAccessHash("/api/v2/storefront/wishlists/default?include=wished_products,wished_products.variant,wished_products.variant.product,wished_products.variant.product.manufacturer");
	...
	public void user_clears_the_basket() {
		...
		apibase.patchRequest("/api/v2/storefront/cart/empty");
	}
